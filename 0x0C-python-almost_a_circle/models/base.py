...
class Base:
    ...
    Serves as the core for all other classes in project 0x0C*.

    Attributes:
        __nb_objects (int): The count of instantiated Base instances.
    """
    ...
    def load_from_file(cls):
        """
        Return a list of instances of a class instantiated from a file of JSON strings.
